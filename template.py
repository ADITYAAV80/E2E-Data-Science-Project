...
project_name="DataScienceWorkflow"
...
list_of_files = [
    ...
    ".github/workflows/.gitkeep",  # Ensures the workflows folder exists for GitHub Actions
    ...
    "research/research.ipynb",  # Jupyter Notebook for experimentation and prototyping
